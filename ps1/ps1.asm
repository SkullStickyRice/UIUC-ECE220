...
OUTERLOOP   
	ADD   R4,R0,R3            ; Copy outer count into inner count
...
INNERLOOP   
	...
	STI R1, RESULT            ; This address contains X\!
    	TRAP x25
  
INPUT   .FILL  x0005              ; Input for X\!, in this case X = 5
ZERO	.FILL  x0000		  ; 2's complement of 0
NEGONE  .FILL  xFFFF              ; 2's complement of 1 (i.e. \-1)
